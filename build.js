...
/***/ function(module, exports, __webpack_require__) {
	...
	var id = 1; // To generate unique id
	
	var getTaskSchema = function getTaskSchema(task) {
	  var schema = {
	    id: 0,
	    label: '',
	    isEditing: false
	  ...
	  return task == null ? schema : Object.assign({}, schema, task);
	};
	...
	var vm = new _vue2.default({
	  ...
	  methods: {
	    ...
	    cancelCreateTask: function cancelCreateTask() {
	    ...
	    editTask: function editTask(id) {
	      ...
	      this.tasks = this.tasks.map(function (task) {
	        if (task.id === id) {
	          _this.isEditingForm = _extends({}, task, {
	            isEditing: true
	          });
	    ...
	    cancelEditTask: function cancelEditTask(id) {
	      this.isEditingForm = getTaskSchema();
	      this.tasks = this.tasks.map(function (task) {
	        return task.id === id ? _extends({}, task, {
	          isEditing: false
	        }) : task;
	      });
	    },
	    updateTask: function updateTask(id, data) {
	      this.tasks = this.tasks.map(function (task) {
	        return task.id === id ? _extends({}, data, {
	          isEditing: false
	        }) : task;
	      });
	    },
	    archiveTask: function archiveTask(id) {
	      this.archivedIds = [].concat(_toConsumableArray(this.archivedIds), [id]);
	    },
	    restoreTask: function restoreTask(_id) {
	      this.archivedIds = this.archivedIds.filter(function (id) {
	        return id !== _id;
	      });
	    },
	    removeTask: function removeTask(_id) {
	  ...
	  computed: {
	    visibleTasks: function visibleTasks() {
	      ...
	      return this.tasks.filter(function (task) {
	        return _this2.archivedIds.indexOf(task.id) === -1;
	      });
	    },
	    archivedTasks: function archivedTasks() {
	      var _this3 = this;
	
	      return this.archivedIds.map(function (id) {
	        return _this3.archivedIds.indexOf(task.id) !== -1;
	      });
	    }
	  }
	});
	
	vm.$watch('isCreatingForm', function () {
